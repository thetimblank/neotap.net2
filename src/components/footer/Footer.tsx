const Footer = () => {
   return (
      <div className='footer'>
         <h1 style={{ color: 'var(--text-h3)' }}>NEOTAP COMPANY</h1>
         <p style={{ color: 'var(--text-h3)' }}>more coming in the very near future ♥</p>
         <div className='footer-grid'>
            ...
            <a href='https://github.com/neo-zip' title='GitHub'>
               <svg
                  fill='#fff'
                  xmlns='http://www.w3.org/2000/svg'
                  viewBox='0 0 50 50'
            ...
            <a href='#top' title='Return to top of the page'>
               <svg
                  fill='#fff'
                  xmlns='http://www.w3.org/2000/svg'
                  ...
                  height='70px'
                  className='footer-icon'>
                  <path d='M22.5 41.9V17.7l-5.9 5.9-2.1-2.1L24 12l9.5 9.5-2.1 2.1-5.9-5.9v24.2ZM8 9V6h32v3Z'></path>
               </svg>
            </a>
            <script
               src='https://cdnjs.cloudflare.com/ajax/libs/vanilla-tilt/1.7.2/vanilla-tilt.min.js'
               type='text/javascript'></script>
            <script src='https://cdnjs.cloudflare.com/ajax/libs/gsap/3.11.0/gsap.min.js' type='text/javascript'></script>
            <script src='https://cdnjs.cloudflare.com/ajax/libs/gsap/3.11.0/ScrollTrigger.min.js' type='text/javascript'></script>
         </div>
      </div>
   );
};
