...
const Page: React.FC = () => {
   ...
   const handleClick = () => {
      ...
      controls.start({
         rotate: clicks * 360,
         transition: { duration: Math.max(0.5 - clicks * 0.05, 0.1) }
       });
   };

   const transitionDuration = Math.max(0.5 - clicks * 0.05, 0.1);
   ...
   return (
      <div className='full center clicker'>
         ...
         {clicks >= 100 && <Confetti width={width} height={height} recycle={false} />}
         <motion.div
